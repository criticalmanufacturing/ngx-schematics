...
export default function (_options: Schema): Rule {
    return async (tree: Tree, _context: SchematicContext) => {
        ...
        _options.name = parsedPath.name.replace(/-?(data)?-?(source)?$/, '');
        ...
        return chain([
            ...
            updateMetadataPackageInfo(project, { dataSources: [strings.classify(_options.name) + 'DataSource'], package: _options.project })
        ]);
    }
}